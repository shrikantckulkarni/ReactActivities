...
{
    public static async Task SeeedData(AppDbContext context,UserManager<User> userManager)
    {
        ...
        if (context.ReactActivities.Any()) return;

        var reactactivies = new List<ReactActivity>()
        {
            new() {
        ...
        context.ReactActivities.AddRange(reactactivies);
